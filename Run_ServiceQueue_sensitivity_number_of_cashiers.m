...
lambda = 4;
%[text] Departure (service) rate: 1 per 8 minutes, so 5/8 per 5 minutes;
mu = 5/8;
...
%---
%[output:317147d0]
%   data: {"dataType":"text","outputData":{"text":"Optimal number of Registers in system: 9.000000\n","truncated":false}}
%---
%[output:801c7d43]
%   data: {"dataType":"text","outputData":{"text":"Percent of customers waiting more than 5 minutes in system: 3.739627\n","truncated":false}}
%---
%[output:5c08b26c]
%   data: {"dataType":"text","outputData":{"text":"One less than optimal number of registers in system: 8.000000\n","truncated":false}}
%---
%[output:766c72f8]
%   data: {"dataType":"text","outputData":{"text":"Percent of customers waiting more than 5 minutes in system: 12.405298\n","truncated":false}}
%---
